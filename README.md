...
Step 2 — Feed the AI (upload the PDF, or try [Gemini AI](https://gemini.google.com/))  
Step 3 — Give the Command “**Answer using WFGY** + your question” , Prompt examples: ([Prompt PDF on Zenodo](https://zenodo.org/records/15657017))   
